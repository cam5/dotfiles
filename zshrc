...
plugins=(docker git battery ssh-agent colored-man colorize github vagrant brew osx zsh-syntax-highlighting zsh-autosuggestions grunt gulp npm vi-mode wp-cli z zsh_reload tmux)
